  ...
  return useMemo(() => {
    try {
      ...
      const inputs: UserInputs = {
        downPaymentPercent: new Decimal(userInputs.downPaymentPercent || 0).dividedBy(100),
        interestRate: new Decimal(userInputs.interestRate || 0).dividedBy(100),
        mortgageTermYears: userInputs.mortgageTermYears || 30,
        propertyTaxRate: new Decimal(userInputs.propertyTaxRate || 0),
        insuranceRate: new Decimal(userInputs.insuranceRate || 0),
        mortgageInsuranceType: userInputs.mortgageInsuranceType,
        yearlyHOA: new Decimal(userInputs.yearlyHOA || 0),
        incomeTaxRate: new Decimal(userInputs.incomeTaxRate || 0).dividedBy(100),
        yearlyGrossIncome: new Decimal(userInputs.yearlyGrossIncome || 0),
        borrowerDebts: (userInputs.borrowerDebts || []).map((d: any) => new Decimal(typeof d === "number" ? d : (d?.amount || 0))),
        coBorrowerIncome: new Decimal(userInputs.coBorrowerIncome || 0),

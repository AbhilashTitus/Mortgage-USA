...
export function AuthContainer() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 flex items-center justify-center p-4 sm:p-8">
      {/* Back button */}
      <Link href="/" className="absolute top-8 left-8 flex items-center text-slate-500 hover:text-[#003087] transition-colors font-medium">
        <ArrowLeft className="w-4 h-4 mr-2" />
        Back to Dashboard
      </Link>

      <div className="relative z-10 w-full max-w-5xl min-h-[650px] bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-row -mt-8 sm:-mt-16">
        ...
        >
          {/* We make the inner background 200% width and translate it backwards to create a perfect parallax masking effect. But a simple solid color is easier and less prone to breaking. Let's use a solid Navy background. */}
